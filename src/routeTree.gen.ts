...
import { Route as RecursiveIndexImport } from './routes/recursive/index'
...
const RecursiveIndexRoute = RecursiveIndexImport.update({
  path: '/recursive/',
  getParentRoute: () => rootRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/recursive/': {
      ...
      path: '/recursive'
      fullPath: '/recursive'
      preLoaderRoute: typeof RecursiveIndexImport
      parentRoute: typeof rootRoute
    }
    '/tabs/': {
      id: '/tabs/'
